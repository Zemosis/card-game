...
- Starting from the player to the **left of the dealer** (skipping any folded players), each player may **discard any number of cards** (0 up to all 5) from their hand and draw the same number of replacement cards from the remaining pool.
- This continues clockwise. The dealer goes last.
...
1. **Leading with trump:** If the leading card is a trump suit card, all other players **must** play a trump suit card if they have one. If a player has no trump suit cards, they may play any card.

2. **Leading with a non-trump suit:** Players must follow the led suit with a **higher-ranking card of the same suit** if they have one. If they cannot follow suit (or cannot play higher), they may play any card.

3. **Winning a trick:** The highest trump card in the trick wins. If no trump cards were played, the highest card of the led suit wins. The winner of each trick **claims it as 1 point worth of scoring**.
...
> Example: The first player leads the King of trumps. A player holding the Ace of trumps plays a 10 of trumps instead. From that point on, their trump Ace is powerless.
