...
/**
 * GameChat Component
 * @param {Array} messages - Array of message objects { id, type, sender, text, timestamp }
...
const GameChat = ({ messages = [], onSendMessage }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-900 border-l border-gray-700">
      ...
      {/* Input Area */}
      <form onSubmit={handleSend} className="p-2 border-t border-gray-700 bg-gray-800">
